      ...
      <AlertDialog open={showAgeVerification}>
        <AlertDialogContent className="bg-zinc-900 border-white/10 max-w-md">
          ...
          <AlertDialogFooter className="flex-col sm:flex-row gap-3">
            <Button onClick={handleAgeDeny} variant="outline" className="w-full border-white/20 bg-white/5 text-white hover:bg-white/10">
              I am under 21
            </Button>
            <Button onClick={handleAgeConfirm} className="w-full bg-emerald-600 hover:bg-emerald-500 text-white">
              I am 21 or older
            </Button>
          </AlertDialogFooter>
        </AlertDialogContent>
