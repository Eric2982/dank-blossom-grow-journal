...
describe('Digital Asset Links JSON', () => {
  ...
  it('should be located in public/ so it is served over HTTPS on archetypal-grow-wise-log.base44.app, ju-j4z6.test-app.link, and dankblossom.app', () => {
    ...
    //   https://dankblossom.app/.well-known/assetlinks.json
    ...
    expect(REQUIRED_HTTPS_DOMAINS).toContain('dankblossom.app');
  });
