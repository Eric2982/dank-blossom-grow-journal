...
export default function StrainAnalytics({ readings }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-white text-lg font-light mb-4">Growth Trends</h3>
        ...
        <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6">
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={chartData}>
              ...
              <Line type="monotone" dataKey="temp" stroke="#fb923c" name="Temp (°F)" strokeWidth={2} />
              <Line type="monotone" dataKey="humidity" stroke="#60a5fa" name="Humidity (%)" strokeWidth={2} />
              <Line type="monotone" dataKey="vpd" stroke="#c084fc" name="VPD (kPa)" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </div>
