  ...
  const handleSearchExternal = async (e) => {
    ...
    try {
      const result = await base44.integrations.Core.InvokeLLM({
        prompt: `Search for "${searchQuery}" grow equipment and return a list of 5 products with their prices from different online retailers. Include product name, retailer, price, and link.`,
